...
<head>
    ...
    <script>
      window.onload = function() {    
        ...
        submitButton.addEventListener("click", getMutationsData);
          ...
          xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
              ...
              for (i = 0; i < res.length; i++) {
                ...
                datagridEle.innerHTML = res[i].datagridHTML;
                ...
                mutationsChartData.push({
                    ...
                    showInLegend: true,
                    name: "illumina_miseq",
                    dataPoints: res[i].illumina_miseq
                },{
                    type: "stackedColumn",
                    showInLegend: true,
                    name: "illumina_novaseq_6000",
                    dataPoints: res[i].illumina_novaseq_6000
                },{
                    type: "stackedColumn",
                    showInLegend: true,
                    name: "nextseq_500",
                    dataPoints: res[i].nextseq_500
                },{
                    type: "stackedColumn",
                    showInLegend: true,
                    name: "nextseq_550",
                    dataPoints: res[i].nextseq_550
                });
