        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                  <a class="navbar-brand" href="index.php">SARS-CoV2</a>
                </div>
...
<b>Warning</b>:  include(./ProtienInfo.php): failed to open stream: No such file or directory in <b>C:\xampp\htdocs\php_su\GenomeSearch.php</b> on line <b>10</b><br />
<br />
<b>Warning</b>:  include(): Failed opening './ProtienInfo.php' for inclusion (include_path='C:\xampp\php\PEAR') in <b>C:\xampp\htdocs\php_su\GenomeSearch.php</b> on line <b>10</b><br />
    ...
    <script>
      ...
      function getCovCov2ComparisonData() {
        ...
        // console.log(document.getElementById("proteininner").innerText);
        // console.log(typeof(protein));
        // if (inputProtein === undefined || protein === inputProtein ) {
        //   var protein = document.getElementById("Protein").value;
        // } else {
        //   var protein = inputProtein;
        // }
        // var protein = document.getElementById("Protein").value;
        console.log(protein);
        ...
        // console.log(data)
          ...
          xmlHttpHtmlPost.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {   
              ...
              const colorli = Array( "#4F73FF", "#FF4F1B","#4FFF66", "#FD7CF1", "yellow", "pink", "orange" , "yellow","magenta","#7CFD8C","#00E2FF","#FF57D3", "#DDFFB5", "#B964FF", "#FFCD64","64FFC3" );
